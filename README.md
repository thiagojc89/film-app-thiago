...
This project was created with [`create-react-app`](https://facebook.github.io/create-react-app/docs/getting-started). Once you have forked and cloned this repo, you should run `npm install` inside the folder you cloned, and then run the app with `npm start`.
